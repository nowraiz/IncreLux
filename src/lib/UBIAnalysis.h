...
struct GlobalContext {
    ...
    // std::string outFolder = "/home/IncreLux/example/lll-v4.14/ubi-ia-out/";
    std::string absPath = "/extra/ali/kernel_ir/lll-v4.14_original";
    std::string outFolder = "/extra/ali/IncreLux/warnings/output";
    std::string incFolder = "/extra/ali/IncreLux/warnings/ia-out";
